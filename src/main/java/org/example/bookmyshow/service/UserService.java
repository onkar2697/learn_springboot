...
//                "name",ExampleMatcher.GenericPropertyMatchers.startsWith().ignoreCase());  //check starts with and same we can use for end with

        ExampleMatcher matcher = ExampleMatcher.matching().withMatcher(
                "name",ExampleMatcher.GenericPropertyMatchers.endsWith().ignoreCase());
